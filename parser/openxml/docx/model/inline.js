...
var _styleInline = require('./style/inline');
...
var inline = (function (_require) {
	...
	_createClass(inline, [{
		...
		value: function getNamedStyle() {
			return this.wDoc.style.get(this.getStyleId()) || this.wDoc.style.getDefault(_styleInline2['default'].type);
		}
	}, {
		key: 'getDirectStyle',
		value: function getDirectStyle(pr) {
			return (pr = this.wXml.$1('>rPr')) && new _styleInline2['default'].Properties(pr, this.wDoc, this);
		}
	}, {
		key: '_shouldIgnore',
