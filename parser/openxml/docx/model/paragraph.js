...
var _styleParagraph = require("./style/paragraph");

var _styleParagraph2 = _interopRequireDefault(_styleParagraph);
...
var paragraph = (function (_require) {
	...
	_createClass(paragraph, [{
		...
		value: function getNamedStyle() {
			return this.wDoc.style.get(this.getStyleId()) || this.wDoc.style.getDefault(_styleParagraph2['default'].type);
		}
	}, {
		key: 'getDirectStyle',
		value: function getDirectStyle(pr) {
			if (pr = this.wXml.$1('>pPr')) return new _styleParagraph2['default'].Properties(pr, this.wDoc, this);
		}
	}, {
		key: '_shouldIgnore',
