...
var _styleTable = require("./style/table");

var _styleTable2 = _interopRequireDefault(_styleTable);
...
var table = (function (_require) {
	...
	_createClass(table, [{
		...
		value: function getNamedStyle() {
			return this.wDoc.style.get(this.getStyleId()) || this.wDoc.style.getDefault(_styleTable2['default'].type);
		}
	}, {
		key: 'getDirectStyle',
