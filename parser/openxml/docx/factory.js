...
define(['require', './model', './model/document', './model/section', './model/body', './model/documentProperty', './model/table', './model/row', './model/cell', './model/paragraph', './model/list', './model/heading', './model/inline', './model/headingInline', './model/text', './model/fieldBegin', './model/fieldInstruct', './model/fieldSeparate', './model/fieldEnd', './model/fieldSimple', './model/bookmarkStart', './model/bookmarkEnd', './model/tab', './model/softHyphen', './model/noBreakHyphen', './model/symbol', './model/br', './model/hyperlink', './model/drawingAnchor', './model/shape', './model/image', './model/chart', './model/diagram', './model/documentStyles', './model/style/document', './model/style/paragraph', './model/style/table', './model/style/inline', './model/style/numbering', './model/style/numberingDefinition', './model/style/list', './model/control/richtext', './model/control/text', './model/control/picture', './model/control/gallery', './model/control/combobox', './model/control/dropdown', './model/control/date', './model/control/checkbox', './model/equation', './model/OLE'], function (require, Model) {
	var models = { '*': Model };
	...
	function factory(_x, _x2, _x3, _x4) {
		var _again = true;
				...
				if (style && style.getOutlineLevel() != -1) return new (require('./model/headingInline'))(wXml, doc, parent);else if (wXml.childNodes.length == 1 || wXml.childNodes == 2 && wXml.firstChild.localName == 'rPr') {
					switch (wXml.lastChild.localName) {
						...
						case 'instrText':
							...
							_x4 = undefined;
							_again = true;
							tag = swap = styleId = style = style = undefined;
							continue _function;
